...
"test Responsibilites for the technical artchitect role", "test jd for teh arch role", "TORONTO", 4, 2, "2024-08-21", true),
("Product Manager", "https://kainos.wd3.myworkdayjobs.com/en-US/Kainos/details/Product-Manager_JR_14352",
"test Responsibiltie for pm", "test description for PM job role","BELFAST", 4, 3, "2024-08-31", true),
("Sales Development Representative",
"https://kainos.wd3.myworkdayjobs.com/en-US/Kainos/details/Sales-Development-Representative---Workday_JR_14420",
"Test responsibilties for sales devel rep", "test description for sales dev rep", "BELFAST", 2, 1, "2024-09-02", true);